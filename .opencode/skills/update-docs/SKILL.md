...
- Nuevos componentes, servicios o hooks creados
...
### Anadido
- Nueva dependencia: @tanstack/react-query@5.x (gestión de estado servidor)
- Nuevo archivo: src/services/cuentasService.ts
- Nuevo hook: useCuentas.ts
- Nuevo componente: src/components/ui/Button.tsx
...
### Anadido
- Nueva dependencia: @tanstack/react-query@5.x (gestión de estado)
- Nueva dependencia: tailwindcss (estilos)
- Nuevo archivo: src/services/api.ts (configuración fetch)
- Nuevo archivo: src/services/cuentasService.ts
